...
func stun() -> void:
	...
	_player.current_stats.light_energy = base_light_energy * LIGHT_MODIFIER
...
func restore() -> void:
	...
	_restore_tween.tween_property(_player.current_stats, "light_energy", base_light_energy, RESTORE_DURATION)
...
func restore_instantly() -> void:
	...
	_player.current_stats.light_energy = base_light_energy 
