...
const WALL_MATERIAL: StandardMaterial3D = preload("res://map/room_components/wall_material/wall_material.tres")
const TRANSPARENT_WALL_MATERIAL: ShaderMaterial = preload("res://map/room_components/wall_material/transparent_wall_material.tres")
